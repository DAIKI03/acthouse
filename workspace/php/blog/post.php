	...
	<?php
		...
		if (empty($title) or empty($content)) {
			...
			if (isset($_POST['draft'])) {
				...
				$sql = "insert into posts (title, content, category, status, created_at, updated_at)values (?, ?, ?, ?, current_timestamp, current_timestamp)";
			...
			$sql = "update posts set image_path = ?,
				image_type = ? where id = ?";
